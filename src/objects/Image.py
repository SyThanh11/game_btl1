...
class Image:
    ...
    def get_width(self):
        return self.__texture.get_width()
    ...
    def get_display_width(self):
        return self.get_width() * self.__scale[0] * self.__viewport[2]

    def get_display_height(self):
        return self.get_height() * self.__scale[1] * self.__viewport[3]

    def set_viewport(self, x, y, width_ratio, height_ratio):
        if width_ratio > 1:
            width_ratio = 1
        elif width_ratio < 0:
            width_ratio = 0
    ...
    def render(self):
        if self.scene:
            self.__texture.set_alpha(self.__alpha)
            surface = pygame.Surface((self.get_width() * self.__viewport[2],
                                      self.get_height() * self.__viewport[3]), pygame.SRCALPHA)
            surface.blit(self.__texture, (self.__viewport[0], self.__viewport[1]))
